...
function ThemeToggleButton() {
  ...
  return (
    <button className="flex items-center space-x-2 cursor-pointer" onClick={handleToggle}>
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className="w-3.5 h-3.5 md:w-4 md:h-4 dark:fill-light-element fill-dark-element">
      ...
      <span className="text-[0.8em] font-semibold dark:text-light-element">Dark Mode</span>
  </button>
  )
}
